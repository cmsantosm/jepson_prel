...
fwd.path <- "/home/csantosm/jepson_16s/reads/raw_j3/FWD/" 
rvs.path <- "/home/csantosm/jepson_16s/reads/raw_j3/RVS/"
...
filtFs <- file.path("/home/csantosm/jepson_16s/reads/raw_j3/filtered/", paste0(sample.names, "_F_filt.fastq.gz"))
filtRs <- file.path("/home/csantosm/jepson_16s/reads/raw_j3/filtered/", paste0(sample.names, "_R_filt.fastq.gz"))
...
pdf("/home/csantosm/jepson_16s/qual_plots/err3_FWD.pdf")
plotErrors(errF, nominalQ=TRUE)
dev.off()

pdf("/home/csantosm/jepson_16s/qual_plots/err3_RVS.pdf")
...
saveRDS(seqtab.nochim, "/home/csantosm/jepson_16s/dada_files/otu_dada3.RDS")
saveRDS(taxa, "/home/csantosm/jepson_16s/dada_files/tax_dada3.RDS")
saveRDS(otu, "/home/csantosm/jepson_16s/dada_files/otu3.RDS")
saveRDS(otu.tax, "/home/csantosm/jepson_16s/dada_files/tax3.RDS")
saveRDS(track, "/home/csantosm/jepson_16s/dada_files/track3.RDS")
