...
rm ${path}trimmed${folder}/${sample}_R1_trimmed.fq.gz 
rm ${path}unpaired${folder}/${sample}_R1_unpaired.fq.gz 
rm ${path}trimmed${folder}/${sample}_R2_trimmed.fq.gz 
rm ${path}unpaired${folder}/${sample}_R2_unpaired.fq.gz
